...
image1 = cv2.imread('Images/kepka1.jpg')
image1 = np.array(cv2.cvtColor(image1, cv2.COLOR_BGR2RGB))
image2 = cv2.imread('Images/kepka2.jpg')
image2 = np.array(cv2.cvtColor(image2, cv2.COLOR_BGR2RGB))
image3 = cv2.imread('Images/kepka3.jpg')
image3 = np.array(cv2.cvtColor(image3, cv2.COLOR_BGR2RGB))
images = (image1,image2,image3)
np.save("Images/images",images)

gray1 = cv2.imread('Images/mask1.bmp', 0)
gray2 = cv2.imread('Images/mask2.bmp', 0)
gray3 = cv2.imread('Images/mask3.bmp', 0)
...
np.save("Images/seeds",masks)

check = np.load("Images/images.npy")
plt.imshow(check[2])
plt.show()